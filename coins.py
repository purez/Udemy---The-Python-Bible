...
class Coin:
    def __init__(self, rare=False, clean=True, heads = True, **kwargs): # Unpacking
...
for coin in coins:
    ...
    string = "{} - Colour: {}, value:{}, diameter(mm):{}, thickness(mm):{}, number of edges:{}, mass(g):{}".format(*arguments) # Packing
    print(string)
